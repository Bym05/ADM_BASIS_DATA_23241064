...
-- Mengambil nama customer dari tabel customer
SELECT nama FROM customer;

-- Mengambil nama customer dan alamat dari tabel customer
SELECT nama, alamat FROM customer;

-- Mengambil nama agen dan jenis kelamin dari tabel agen
SELECT nama_agen, jenis_kelamin FROM agen;

-- Mengambil nama bus dan tujuan menggunakan prefix nama tabel
SELECT bus.nama_bus, bus.tujuan FROM bus;

-- Mengambil nama bus dan tujuan menggunakan prefix nama database dan tabel
SELECT tiket_bus.bus.nama_bus, tiket_bus.bus.tujuan FROM bus;

-- Mengganti alias nama bus menjadi nb dari tabel bus
SELECT nama_bus AS nb FROM bus;
SELECT nama_bus nb FROM bus;

-- Memberikan alias tabel untuk customer sebagai cst lalu ambil nama dan alamatnya
SELECT cst.nama, cst.alamat FROM customer AS cst;

-- Mengambil nama kelas dan harga dari tabel kelas menggunakan alias tabel kls
SELECT kls.nama_kelas, kls.harga FROM kelas AS kls;

-- Mengambil jam dan hari keberangkatan dari tabel jadwal
SELECT jam, hari FROM jadwal;

-- Mengambil nama kelas dan fasilitas dari tabel fasilitas
SELECT nama_kelas, fasilitas FROM fasilitas;
